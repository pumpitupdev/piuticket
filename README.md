...
## Initialization
As such, windows (dev) builds will look for it via "\\\\.\\ezusb-0" -> "\\\\.\\ezusb-3" and Linux will search either "/proc/bus/usb/devices" or "/sys/kernel/debug/usb/devices" depending on how fucking... ancient the kernel is.
